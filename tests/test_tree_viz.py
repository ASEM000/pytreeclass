...
def test_model_viz_frozen_value():
    ...
    assert (
        ...
        # trunk-ignore(flake8/E501)
        "┌────┬──────┬─────────┬──────────────┬───────────────────┬────────────┐\n│Name│Type  │Param #  │Size          │Config             │Input/Output│\n├────┼──────┼─────────┼──────────────┼───────────────────┼────────────┤\n│l1  │Linear│256(0)   │1.00KB(0.00B) │weight=f32[1,128]  │f32[100,1]  │\n│    │      │         │              │bias=f32[1,128]    │f32[100,128]│\n├────┼──────┼─────────┼──────────────┼───────────────────┼────────────┤\n│l2  │Linear│16,512(0)│64.50KB(0.00B)│weight=f32[128,128]│f32[100,128]│\n│    │      │         │              │bias=f32[1,128]    │f32[100,128]│\n├────┼──────┼─────────┼──────────────┼───────────────────┼────────────┤\n│l3  │Linear│129(0)   │516.00B(0.00B)│weight=f32[128,1]  │f32[100,128]│\n│    │      │         │              │bias=f32[1,1]      │f32[100,1]  │\n└────┴──────┴─────────┴──────────────┴───────────────────┴────────────┘\nTotal count :\t16,897(0)\nDynamic count :\t16,897(0)\nFrozen count :\t0(0)\n-----------------------------------------------------------------------\nTotal size :\t66.00KB(0.00B)\nDynamic size :\t66.00KB(0.00B)\nFrozen size :\t0.00B(0.00B)\n=======================================================================",
        # trunk-ignore(flake8/E501)
        "┌────────┬──────┬─────────┬──────────────┬───────────────────┐\n│Name    │Type  │Param #  │Size          │Config             │\n├────────┼──────┼─────────┼──────────────┼───────────────────┤\n│l1      │Linear│256(0)   │1.00KB(0.00B) │weight=f32[1,128]  │\n│(frozen)│      │         │              │bias=f32[1,128]    │\n├────────┼──────┼─────────┼──────────────┼───────────────────┤\n│l2      │Linear│16,512(0)│64.50KB(0.00B)│weight=f32[128,128]│\n│(frozen)│      │         │              │bias=f32[1,128]    │\n├────────┼──────┼─────────┼──────────────┼───────────────────┤\n│l3      │Linear│129(0)   │516.00B(0.00B)│weight=f32[128,1]  │\n│(frozen)│      │         │              │bias=f32[1,1]      │\n└────────┴──────┴─────────┴──────────────┴───────────────────┘\nTotal count :\t16,897(0)\nDynamic count :\t0(0)\nFrozen count :\t16,897(0)\n--------------------------------------------------------------\nTotal size :\t66.00KB(0.00B)\nDynamic size :\t0.00B(0.00B)\nFrozen size :\t66.00KB(0.00B)\n==============================================================",
        # trunk-ignore(flake8/E501)
        "┌────────┬──────┬─────────┬──────────────┬───────────────────┬────────────┐\n│Name    │Type  │Param #  │Size          │Config             │Input/Output│\n├────────┼──────┼─────────┼──────────────┼───────────────────┼────────────┤\n│l1      │Linear│256(0)   │1.00KB(0.00B) │weight=f32[1,128]  │f32[100,1]  │\n│(frozen)│      │         │              │bias=f32[1,128]    │f32[100,128]│\n├────────┼──────┼─────────┼──────────────┼───────────────────┼────────────┤\n│l2      │Linear│16,512(0)│64.50KB(0.00B)│weight=f32[128,128]│f32[100,128]│\n│(frozen)│      │         │              │bias=f32[1,128]    │f32[100,128]│\n├────────┼──────┼─────────┼──────────────┼───────────────────┼────────────┤\n│l3      │Linear│129(0)   │516.00B(0.00B)│weight=f32[128,1]  │f32[100,128]│\n│(frozen)│      │         │              │bias=f32[1,1]      │f32[100,1]  │\n└────────┴──────┴─────────┴──────────────┴───────────────────┴────────────┘\nTotal count :\t16,897(0)\nDynamic count :\t0(0)\nFrozen count :\t16,897(0)\n---------------------------------------------------------------------------\nTotal size :\t66.00KB(0.00B)\nDynamic size :\t0.00B(0.00B)\nFrozen size :\t66.00KB(0.00B)\n===========================================================================",
        # trunk-ignore(flake8/E501)
        "StackedLinear\n    ├── l1=Linear\n    │   ├── weight=f32[1,128]\n    │   ├── bias=f32[1,128]\n    │   └*─ notes='string'  \n    ├── l2=Linear\n    │   ├── weight=f32[128,128]\n    │   ├── bias=f32[1,128]\n    │   └*─ notes='string'  \n    └── l3=Linear\n        ├── weight=f32[128,1]\n        ├── bias=f32[1,1]\n        └*─ notes='string'      ",
        # trunk-ignore(flake8/E501)
        "StackedLinear\n    ├#─ l1=Linear\n    │   ├#─ weight=f32[1,128]\n    │   ├#─ bias=f32[1,128]\n    │   └#─ notes='string'  \n    ├#─ l2=Linear\n    │   ├#─ weight=f32[128,128]\n    │   ├#─ bias=f32[1,128]\n    │   └#─ notes='string'  \n    └#─ l3=Linear\n        ├#─ weight=f32[128,1]\n        ├#─ bias=f32[1,1]\n        └#─ notes='string'      ",
