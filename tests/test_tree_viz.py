...
def test_repr_str():
    ...
    assert str_string == "Test(a=10,b=20,c=[1 2 3 4 5],(x)name=A)"
    assert repr_string == "Test(a=10,b=20,c=i32[5],(x)name='A')"
...
def test_repr_true_false():
    ...
    class Test:
        ...
        name: str = pytc.static_field(repr=False)
    ...
    assert A.__repr__() == "Test(b=20,c=f32[10],(x)name='Test')"
    assert (
        A.__str__()
