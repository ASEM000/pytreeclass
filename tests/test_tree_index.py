...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            tree9,
            ClassTree(None, dict(c=None, d=None), np.array([], dtype=np.int32)),
            (tree9 != tree9,),
        ],
        # by ellipsis
        [tree1, tree1, (...,)],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [tree9, 0 + np.array([], dtype=np.int32), (tree9 != tree9,)],
        # by ellipsis
        [tree1, 1 + 2 + 3 + 4, (...,)],
        [tree2, 1 + 2 + 3 + 4, (...,)],
        [tree3, 1 + 2 + 3 + 4, (...,)],
...
def test_name_reduce(tree, expected, where):
    indexer = AtIndexer(tree, where=where)
    assert is_tree_equal(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # by index
        [tree3, (ClassTree(1, ClassSubTree(2, 5), 4), 3), (1, (0, 1))],
...
def test_custom_key():
    ...
    tu.register_pytree_node_with_path(
        ...
        flatten_func_with_path=tree_flatten_with_keys,
